    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="sm">
          Publish
          {initialData.isPublished && <Globe className="text-sky-500 animate-pulse w-4 h-4 ml-2" />}
        </Button>
      </PopoverTrigger>
        ...
        {initialData.isPublished ? (
          <div className="space-y-4">
            <div className="flex items-center gap-x-2">
              ...
              <p className="text-sm font-medium">This note is live on the web.</p>
            </div>
            ...
            <Button onClick={onUnPublish} disabled={isSubmitting} className="w-full text-xs" size="sm">
              Unpublish
            </Button>
          </div>
        ) : (
